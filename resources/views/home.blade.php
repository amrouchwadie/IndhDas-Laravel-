          ...
          <div class="card-body">
            <div class="media static-top-widget">
              <div class="media-body">
                <h6 class="font-roboto">{{ __('Visitor') }}</h6>
                <h4 class="mb-0 counter">    <span id="HitCounter"></span></h4>
              </div>
              <svg xmlns="http://www.w3.org/2000/svg" width="48px" height="48px" viewBox="0 0 64 64">
                <g fill="none" fill-rule="evenodd">
                  <path stroke="#979797" stroke-linecap="square" stroke-width="2" d="M10,60 L52.0475921,60"/>
                  <path fill="#80D25B" d="M31,7 C16.0883118,7 4,19.0883118 4,34 C4,48.9116882 16.0883118,61 31,61 C45.9116882,61 58,48.9116882 58,34 L31,34 L31,7 Z"/>
                  <path fill="#D650C7" d="M34,3.1432976 C48.7259943,4.55740123 60.4425988,16.2740057 61.8567024,31 L34,31 L34,3.1432976 Z"/>
                </g>
              </svg>
            </div>
      ...
      <div class="col-sm-6 col-xl-3 col-lg-6">
        <div class="card o-hidden static-top-widget-card">
          <div class="card-body">
            <div class="media static-top-widget">
              <div class="media-body">
                <h6 class="font-roboto">{{ __('Projects') }}</h6>
                <h4 class="mb-0 counter">
                    
                    @php
                    if ($projects = DB::table('newscontents')->count()) {
      ...
      <div class="col-sm-6 col-xl-3 col-lg-6">
        <div class="card o-hidden">
          <div class="card-body">
            <div class="media static-top-widget">
              <div class="media-body">
                <h6 class="font-roboto">{{ __('Idea Competition') }}</h6>
                <h4 class="mb-0 counter">
                    
                    @php
                    if ($appels = DB::table('appel_projets')->count()) {
      ...
      <div class="col-sm-6 col-xl-3 col-lg-6">
        <div class="card o-hidden">
          <div class="card-body">
            <div class="media static-top-widget">
              <div class="media-body">
                <h6 class="font-roboto">{{ __('User') }}</h6>
                <h4 class="mb-0 counter">
                    @php
            ...
            <div class="row gy-4">
              <div class="col-sm-6">
                <div class="widget-card">
                  ...
                  <h5>$<span class="counter">25698</span></h5><span class="font-roboto"><span class="font-danger">-36%($2658)</span> {{ __('Than Yesterday') }}</span>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="widget-card">
                  ...
                  <h5>
                    @php
                    $averages = DB::table('posts')->avg('id');
                    ...
                    <span class="counter"></span></h5><span class="font-roboto"><span class="font-danger">-@php if ($averages == true && $total == true) {
                        echo $averages*100/$total;
                    } else {
                        # code...
                    }
                      @endphp%(<?php if ($averages) {
                        echo 100/$averages; 
                      } else {
                          # code...
                      }
                  ?>) </span> {{ __('Than last month') }}</span>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="widget-card">
               ...
               $total  = DB::table('posts')->count();    
                ...
                if ($total ==true) {
                    ...
                    @endphp
                    </h5> <span class="font-roboto"><span class="font-success">+@php echo $averages*$total/100; @endphp %(<?php echo $averages; ?>) </span> {{ __('Than Yesterday') }}</span>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="widget-card">
                  ...
                  <h5>$963198</h5><span class="font-roboto"><span class="font-success">+90%($3654) </span> {{ __('Than Yesterday') }}          </span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row gy-4">
              <div class="col-sm-6">
                <div class="widget-card">
                  ...
                  <h5>6981</h5><span class="font-roboto font-success f-w-700"><i class="icofont icofont-arrow-up"></i> 68%</span>
                  <div class="icon-bg">
              ...
              <div class="col-sm-6">
                <div class="widget-card">
                  <div class="media align-self-center">
                    ...
                    <div class="media-body">
                      <h6>{{ __('News Project') }}</h6>
                    </div>
                  </div>
                  <h5>783</h5><span class="font-roboto font-danger f-w-700"><i class="icofont icofont-arrow-down"></i> 12%</span>
                  <div class="icon-bg">
              ...
              <div class="col-sm-6">
                <div class="widget-card">
                  <div class="media align-self-center">
                    ...
                    <div class="media-body">
                      <h6>{{ __('Publications Documents') }}</h6>
                    </div>
                  </div>
                  <h5>$63147</h5><span class="font-roboto font-success f-w-700"><i class="icofont icofont-arrow-up"></i> 50%</span>
                  <div class="icon-bg">
              ...
              <div class="col-sm-6">
                <div class="widget-card">
                  <div class="media align-self-center">
                    ...
                    <div class="media-body">
                      <h6>{{ __('Media Posted') }}</h6>
                    </div>
                  </div>
                  <h5>69</h5><span class="font-roboto font-success f-w-700"><i class="icofont icofont-arrow-up"></i> 20%</span>
                  <div class="icon-bg">
        ...
        <div class="">
          <div class="">
            <div class="feedback-top text-center">
              <h6 class="font-roboto f-w-400"></h6>
              <h4></h4>
            </div>
            ...
            <div class="card o-hidden profile-greeting">
              <div class="card-body">
                ...
                <div class="greeting-user text-center">
                  ...
                  <h4 class="f-w-600"><span id="greeting">{{ __('Hello') }}</span> <span class="right-circle"><i class="fa fa-check-circle f-14 middle"></i></span></h4>
                  <p style="text-align: center"><span style="margin-left: 30%" > {{ __('Today is the perfect time to reboot your mind and make a fresh start.') }}</span></p>
                  <div class="whatsnew-btn"><a class="btn btn-primary">{{ __('Whats up?') }}</a></div>
